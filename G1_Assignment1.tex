...
\bibitem{1}Pan, Jiapu; Tompkins, Willis J.: \textit{'A Real-Time QRS Algorithm'}, 1985
\bibitem{2}Pop, Paul; Frederiksen, Karsten J.; Boesen, Michael R.; Kaminskas, Linas: \textit{'02131 Assignment 1: Software implementation of a personal ECG scanner'}, 2015
\bibitem{3}ECG $http://medical-dictionary.thefreedictionary.com/ECG$ - besøgt: 26-09-2015
\bibitem{4}[QRS Complex] $https://en.wikipedia.org/wiki/QRS_complex$ - besøgt: 28-09-2015
\end{thebibliography}
